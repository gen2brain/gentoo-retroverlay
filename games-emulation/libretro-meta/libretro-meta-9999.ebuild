...
IUSE="+3do 3ds amiga +arcade c64 dos +dreamcast +ds +gameboy +gamecube +genesis +jaguar mame +n64 neocd nes pce +psx +ps2 +psp +saturn +snes +wii"
...
RDEPEND="
	...
	c64? ( games-emulation/vice-libretro )
